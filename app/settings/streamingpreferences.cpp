...
#define SER_INFLUXDB_URL "influxdburl"
...
void StreamingPreferences::reload()
{
    ...
    influxDbUrl = settings.value(SER_INFLUXDB_URL, "http://localhost:8086").toString();
...
void StreamingPreferences::save()
{
    ...
    settings.setValue(SER_INFLUXDB_URL, influxDbUrl);
}
